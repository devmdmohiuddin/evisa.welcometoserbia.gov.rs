        ...
        <div class="sm:w-[1000px] mx-auto space-y-32">
                <div class="space-y-12">
                    ...
                    <div class="sm:grid grid-cols-2">
                      <div class="space-y-8">
                        <div>
                          {user?.image ? <img class="w-[192px] h-[192px] object-cover object-top rounded-sm" src={user?.image} /> : <img class="w-[200px] h-[200px] object-contain object-top rounded-md" src="./images/avatar.png" alt="Avatar" />}
                        </div>
                         <div class="space-y-2">
